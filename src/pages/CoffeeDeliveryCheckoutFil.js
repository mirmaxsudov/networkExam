...
const CoffeeDeliveryCheckoutFil = () => {
  return (
      ...
      <section className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-left text-lg text-base-subtitle font-title-title-s">
        <div className="w-[1120px] flex flex-col items-start justify-start gap-[15px] max-w-full">
          ...
          <div className="self-stretch flex flex-row items-start justify-start gap-[32px] max-w-full text-base font-text-regular-m mq700:gap-[16px] mq925:flex-wrap">
            <div className="flex-1 flex flex-col items-start justify-start gap-[12px] min-w-[416px] max-w-full mq700:min-w-full">
              <div className="self-stretch rounded-md bg-base-card flex flex-col items-start justify-start p-10 box-border gap-[32px] max-w-full mq450:pt-[26px] mq450:pb-[26px] mq450:box-border mq700:gap-[16px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[16px] max-w-full text-sm text-base-text">
                  <div className="w-[200px] rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] whitespace-nowrap border-[1px] border-solid border-base-button">
                    <div className="flex-1 relative leading-[130%]">
                      90 161 01 67
                    </div>
                  </div>
                  <div className="self-stretch rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] max-w-full border-[1px] border-solid border-base-button">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start gap-[12px] max-w-full mq700:flex-wrap">
                    <div className="w-[200px] rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] border-[1px] border-solid border-base-button">
                      <div className="flex-1 relative leading-[130%]">9</div>
                    </div>
                    <div className="flex-1 rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] gap-[4px] min-w-[226px] max-w-full text-base-label border-[1px] border-solid border-base-button mq450:flex-wrap">
                      <div className="flex-1 relative leading-[130%] inline-block min-w-[157px]">
                        Mass graves, Intercom’s code: 9
                      </div>
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start gap-[12px] max-w-full mq700:flex-wrap">
                    <div className="flex-1 rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] min-w-[317px] whitespace-nowrap max-w-full border-[1px] border-solid border-base-button">
                      <div className="flex-1 relative leading-[130%] inline-block max-w-full">
                        Yakkasaroy Region
                      </div>
                    </div>
                    <div className="w-[60px] rounded bg-base-input box-border flex flex-row items-center justify-start py-2.5 px-[11px] border-[1px] border-solid border-base-button">
                      <div className="flex-1 relative leading-[130%]">87</div>
                    </div>
                  </div>
                </div>
              </div>
              <CoffeeCard2
                propBackgroundColor="#ece5f9"
                propBorder="1px solid #8047f8"
                propFlex="0.941"
                propFlex1="0.5969"
              />
            </div>
            <div className="w-[448px] rounded-tl-md rounded-tr-25xl rounded-br-md rounded-bl-25xl bg-base-card flex flex-col items-start justify-start p-10 box-border gap-[24px] min-w-[448px] max-w-full text-right text-sm text-base-text mq700:pt-[26px] mq700:pb-[26px] mq700:box-border mq700:min-w-full mq925:flex-1">
              ...
              <div className="self-stretch rounded-md bg-brand-yellow flex flex-row items-center justify-center py-3 px-5 whitespace-nowrap text-left text-base-white">
                <b className="relative leading-[160%] uppercase">
                  confirmar pedido
                </b>
              </div>
            </div>
...
export default CoffeeDeliveryCheckoutFil;
